        ...
        public MockDataStore()
        {
            ...
            var mockItems = new List<Item>
            {
                ...
                new Item { Id = Guid.NewGuid().ToString(),
                           ...
                           LongDescription = "A WWII carrier with a wooden flight deck. North Island Naval Air Station, San Diego, CA. She was decommissioned and sold for scrap in 1973.",
                           Picture = new Xamarin.Forms.Image {Source = "ticonderoga.jpg" },
                           PictureName = "ticonderoga.jpg" },
                new Item { Id = Guid.NewGuid().ToString(),
                           Text = "NNPS MINSY",
                           Description ="Naval Nuclear Power School",
                           LongDescription = "The Navy's most academically difficult engineering school that was located at the Mare Island, CA Naval Shipyard.\r\n\r\n8 hours of advanced engineering, nuclear physics, metallurgy, etc. classes per day, and even study notes were marked 'Classified'. The school is closed down.",
                ...
                new Item { Id = Guid.NewGuid().ToString(),
                           ...
                           LongDescription = "I was assigned to the A1W prototype. NRTS is 60 miles outside Idaho Falls, Idaho.  The site is closed down now.",
                ...
                new Item { Id = Guid.NewGuid().ToString(),
                           ...
                           LongDescription = "I am a plankowner. The Nimitz was initially built in the Newport News shipyard, then once commissioned, was stationed in Norfolk, VA.  She has other homeports since then.",
