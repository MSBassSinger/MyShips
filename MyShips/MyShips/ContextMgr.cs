...
namespace MyShips
{
    ...
    public sealed class ContextMgr : IDisposable
    {
        ...
        /// </summary>
        private volatile Dictionary<String, Object> m_ContextValues = new Dictionary<String, Object>();
        ...
        private ContextMgr()
        {
            ...
            {
                m_ContextValues = new Dictionary<String, Object>();
            }
        }

        /// <summary>
        /// Gets the dictionary of context values.
        /// The dictionary cannot be set by the calling code, but the dictionary elements can be added, edited, or removed.
        /// </summary>
        /// <returns>Returns a reference to the dictionary.</returns>
        public Dictionary<String, Object> ContextValues
        {
            get
            {
                if (m_ContextValues == null)
